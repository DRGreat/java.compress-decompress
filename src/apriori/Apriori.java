...
public class Apriori {
    ...
    private static  double MIN_SUPPROT = 0.15;//最小支持度百分比
    private static   double MIN_CONFIDENCE=0.9;//最小置信度
    private static boolean endTag = false;//循环状态，迭代标识
    static List<List<String>> record = new ArrayList<>();//数据集
    ...
    public static void main(String[] args){
        ...
        /*************读取数据集**************/
        record = getRecord("E:\\Download\\weka\\Weka-3-8-4\\data\\weather.nominal.arff"); //路径自行修改
        //控制台输出记录
